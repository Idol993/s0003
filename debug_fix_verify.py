...
for step in range(30):
    ...
    balancer_stats = layer.step_balancers(out.gate_output)
    print(f"  step_balancers done ✓")
    if "clusterer/updated" in balancer_stats and balancer_stats["clusterer/updated"]:
        print(f"  ** Clustering updated! num_clusters={balancer_stats.get('clusterer/num_clusters')}")
...
print("\n" + "="*60)
print("ALL 30 STEPS PASSED WITHOUT RETAIN_GRAPH ERROR!")
print("="*60)
